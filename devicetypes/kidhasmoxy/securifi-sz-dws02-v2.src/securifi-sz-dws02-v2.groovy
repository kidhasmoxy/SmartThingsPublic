metadata {
	definition (name: "Securifi SZ-DWS02 v2", namespace: "kidhasmoxy", author: "CCollazo") {
	...
	// simulator metadata
	simulator {
		status "open": "zone status 0x0031 -- extended status 0x00"
		status "closed": "zone status 0x0030 -- extended status 0x00"
	}
