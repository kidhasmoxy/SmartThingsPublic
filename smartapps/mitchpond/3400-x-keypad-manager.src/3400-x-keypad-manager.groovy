...
private execRoutine(armMode) {
    ...
    def params = [
    uri: "https://graph.api.smartthings.com/api/smartapps/installations/33fef02e-bb5f-46ab-9b4b-15f024160651/dismissIncident?name=Security&access_token=" + state.accessToken
    ]
    try {
    httpGet(params) { resp ->
