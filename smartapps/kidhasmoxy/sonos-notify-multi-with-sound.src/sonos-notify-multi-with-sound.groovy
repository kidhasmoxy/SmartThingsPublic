 ...
 */
definition(
	name: "Sonos Notify Multi with Sound",
	namespace: "kidhasmoxy",
	author: "ChrisC",
	description: "Play a sound or custom message through multiple Sonos speakers when the mode changes or other events occur.",
...
def mainPage() {
	dynamicPage(name: "mainPage") {
		...
		section {
			input "sonos", "capability.musicPlayer", title: "On these Sonos players", required: true, multiple: true
		}
